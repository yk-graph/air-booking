...
export default async function PassengerPage({
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      <h1 className="mb-4 text-2xl font-semibold">Passenger information — coming soon</h1>
      <p className="mb-6 text-gray-600">This step will collect passenger details.</p>
